...
export default function PrivacyPage() {
  return (
    <div className="page-content">
      ...
      <p>
        Marginal Data is operated by Javi Labs LLC ("we," "us"), which is the
        data controller for the purposes described below. Use the contact
        form at the bottom of this page for any privacy-related request.
      </p>

      <h2>Analytics</h2>
      <p>
        We use Umami, a privacy-focused analytics platform, to understand
        ...
        stored within the EU (Germany). Umami acts as our data processor
        under a Data Processing Agreement.
      </p>
      <p>
        Because no cookies or comparable tracking technology are used, no
        cookie consent banner is required, and we process this data on the
      ...
      <p>
        ...
        other privacy question, reach out below and we'll respond.
      </p>

      <h2>Changes</h2>
      <p>If our data practices change, this page will change with them.</p>
