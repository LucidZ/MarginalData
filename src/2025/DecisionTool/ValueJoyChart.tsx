...
export default function ValueJoyChart({
  ...
  return (
    <div className="value-joy-chart">
      <h2>Step 2: Map Value & Joy</h2>
      {activeRow ? (
        <p className="instruction-text">
          Drag the dots to show where {activeRow.category || "this category"}{" "}
          falls for each option
        </p>
      ) : (
        <p className="instruction-text">
          Click a category above to start placing it on the chart
        </p>
      )}
        ...
        >
          ...
          {activeRow && activeRow.chartData && (
            <g>
              ...
              <line
                className="connecting-line"
                x1={toSVGCoords(activeRow.chartData.aPosition.x, activeRow.chartData.aPosition.y).x}
                y1={toSVGCoords(activeRow.chartData.aPosition.x, activeRow.chartData.aPosition.y).y}
                x2={toSVGCoords(activeRow.chartData.bPosition.x, activeRow.chartData.bPosition.y).x}
                y2={toSVGCoords(activeRow.chartData.bPosition.x, activeRow.chartData.bPosition.y).y}
              ...
              {(() => {
                ...
                const midY = (aPos.y + bPos.y) / 2;
                const angle =
                  (Math.atan2(bPos.y - aPos.y, bPos.x - aPos.x) * 180) /
                  Math.PI;
              ...
              <circle
                className="dot option-a"
                cx={toSVGCoords(activeRow.chartData.aPosition.x, activeRow.chartData.aPosition.y).x}
                cy={toSVGCoords(activeRow.chartData.aPosition.x, activeRow.chartData.aPosition.y).y}
                r={8}
              ...
              <circle
                className="dot option-b"
                cx={toSVGCoords(activeRow.chartData.bPosition.x, activeRow.chartData.bPosition.y).x}
                cy={toSVGCoords(activeRow.chartData.bPosition.x, activeRow.chartData.bPosition.y).y}
                r={8}
